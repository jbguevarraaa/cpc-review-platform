...
_Last updated: 2026-09-22 (10,000-series Parts 1-3 extended with 8 solved prework case questions plus two new code families, hidradenitis excision 11450-11471 and drug-delivery implants 11981-11983, both verified against CPT 2026; 20,000-series Part 1 extended with a new Arthroscopic Procedures topic (29870-29883, cross-checked against CPT 2026) plus 12 solved case questions from a second training deck folded into the existing fracture/cast/injection topics; 10,000-series Integumentary rebuilt in the newer reviewer format — Parts 1-3, schematics, 16 solved deck cases, 10-Q quiz, flashcards, and a site-wide highlight/unhighlight reading-progress tool added to all kit-based reviewers and discussion guides; Discussion Guide Q&A companion pages added for all 6 series with a training discussion-guide PDF — 10,000, 20,000, 33,000, 40,000, 50,000, and E/M 99,000 — each answering every question step by step, cross-checked against CPT 2026; E/M 99,000-series reviewer, quiz, and flashcards added; 60,000-series Neuro-Endocrine reviewer, quiz, and flashcards added; 50,000-series Genitourinary reviewer, quiz, and flashcards added; 40,000-series Digestive reviewer, quiz, and flashcards added; ICD-10 complete for every chapter with narrative guidelines). This tracks study-content coverage across the site against the actual CPC exam blueprint — separate from PROJECT_MEMORY.md, which tracks codebase/architecture health. Read this at the start of a session to see what's built, what's pending, and what to prioritize given the exam timeline. Update it whenever a reviewer/quiz/flashcard page is added or a series is completed._
...
|---|---|---|---|---|
| 10,000 (Integumentary) | ✅ Parts 1-3 rebuilt 2026-09-22 in the newer reviewer format from a training deck cross-checked to CPT 2026: removal procedures (shaving, excision, destruction, Mohs), repair procedures (repair/closure, ATT, skin replacement, flaps), other procedures (I&D, pressure ulcers, burns, nails, pilonidal cysts, breast) — nails/pilonidal cysts sourced fresh from the codebook since the deck did not cover them; 16 slide cases solved (one left as an honest "hard scenario" where the scenario under-specifies a measurement); 7 SVG schematics; 2 deck typos corrected (Mohs code range, skin substitute 15271 vs "15721"). ✅ 8 more solved cases added 2026-09-22 from a separate prework exercise set, plus a hidradenitis excision code table (11450-11471, Part 1) and a new Drug-Delivery Implants section (11981-11983, Part 3) that filled real gaps the prework exposed | ✅ (3 legacy quizzes) | ✅ (10 Q) + ✅ flashcards. Discussion Guide Q&A also live (10 topics) | Legacy study-tips/quiz pages kept alongside the new reviewer, not replaced |
| 20,000 (Musculoskeletal) | 🟡 Parts 1–3 done (General, Head–Spine, Abdomen–Wrist); **Part 4 (Hand & Fingers, Pelvis & Hip, Femur & Knee) and Part 5 (Leg/Ankle/Foot) pending** | ✅ | ✅ | Largest series in scope — source text fully in hand via PDF extraction now. ✅ Discussion Guide Q&A added 2026-09-22 (7 topics). ✅ Part 1 extended 2026-09-22 with a new Topic 12 "Arthroscopic Procedures" (29870-29883, verified against CPT 2026 — knee arthroscopy is no longer a gap) plus 12 solved deck-case questions added to the existing fracture/cast/trigger-point/arthrocentesis topics (Topics 1, 3, 7), sourced from a second training deck ("20K SERIES REVIEWER.pdf") |
...
|---|---|---|
| Evaluation & Management (E/M) | ✅ Guidelines + quiz + consolidated reviewer; ✅ 99,000 series Parts 1–3 built 2026-09-21 (E/M layout and common rules, picking the level by MDM or time, critical care, prolonged services; 3 deck cases solved; 3 SVG schematics; hub at /cpt/e-m/99,000) + ✅ quiz (10 Q) + ✅ flashcards + ✅ Discussion Guide Q&A added 2026-09-22 (8 topics) | High exam weight — already solid. Deck differences flagged on the hub (old 3-of-3 / 2-of-3 key components and 50% counseling rule vs 2026 MDM/time, deleted 99201 and 99354–99357, 93598) |
