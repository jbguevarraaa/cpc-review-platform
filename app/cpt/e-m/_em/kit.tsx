...
const s = {
  main: { maxWidth: "1160px", margin: "0 auto", padding: "36px clamp(12px, 4vw, 24px) 64px", minHeight: "100vh", background: "#f7faf9", color: "#17212b", fontFamily: "Arial, sans-serif" },
  hero: { background: "linear-gradient(135deg, #12343b, #0f766e)", color: "white", padding: "48px clamp(20px, 4vw, 44px)", borderRadius: "18px", marginBottom: "26px", boxShadow: "0 12px 28px rgba(18,52,59,0.22)" },
  kicker: { margin: "0 0 10px", color: "#b7f7e8", fontWeight: 800, letterSpacing: "0.08em" },
  nav: { display: "flex", flexWrap: "wrap" as const, gap: "10px", marginBottom: "22px" },
  navLink: { textDecoration: "none", color: "#0f766e", background: "#ffffff", border: "1px solid #d7e2df", borderRadius: "999px", padding: "10px 15px", fontWeight: 700, fontSize: "14px" },
  pagerLink: { textDecoration: "none", color: "#0f766e", background: "#ecf8f6", border: "1px solid #b7f7e8", borderRadius: "999px", padding: "8px 16px", fontWeight: 700, fontSize: "14px" },
  pagerActive: { textDecoration: "none", color: "#fff", background: "#0f766e", border: "1px solid #0f766e", borderRadius: "999px", padding: "8px 16px", fontWeight: 700, fontSize: "14px" },
  intro: { background: "#ecf8f6", border: "1px solid #b7f7e8", borderLeft: "7px solid #0f766e", borderRadius: "12px", padding: "22px 24px", marginBottom: "26px", lineHeight: 1.7 },
  section: { background: "#ffffff", border: "1px solid #d7e2df", borderRadius: "14px", padding: "24px clamp(14px, 3.5vw, 28px)", marginBottom: "22px", boxShadow: "0 5px 16px rgba(18,52,59,0.06)" },
  sectionHeader: { display: "flex", alignItems: "center", gap: "14px", marginBottom: "10px", flexWrap: "wrap" as const },
  num: { background: "#0f766e", color: "#fff", width: "36px", height: "36px", minWidth: "36px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: "15px" },
  title: { margin: 0, fontSize: "22px", color: "#111827" },
  range: { background: "#ecf8f6", border: "1px solid #b7f7e8", color: "#0f766e", borderRadius: "999px", padding: "4px 12px", fontWeight: 800, fontSize: "13px", fontFamily: "Consolas, monospace" },
  p: { lineHeight: 1.75, margin: "0 0 10px" },
  catTitle: { margin: "18px 0 8px", fontSize: "16px", color: "#0f766e", fontWeight: 800 },
  codeList: { listStyle: "none", padding: 0, margin: "0 0 4px", display: "grid", gap: "7px" },
  codeItem: { display: "flex", flexWrap: "wrap" as const, gap: "6px 12px", alignItems: "baseline", background: "#f7faf9", border: "1px solid #d7e2df", borderRadius: "8px", padding: "8px 13px" },
  codeChip: { fontWeight: 800, color: "#0f766e", minWidth: "120px", fontFamily: "Consolas, monospace", fontSize: "13.5px" },
  ul: { margin: 0, paddingLeft: "20px", display: "grid", gap: "8px" },
  diagramBox: { background: "#f7faf9", border: "1px solid #d7e2df", borderRadius: "14px", padding: "18px", margin: "16px 0", textAlign: "center" as const, overflowX: "auto" as const },
};
...
export function DiagramFrame({ caption, children }: { caption: string; children: ReactNode }) {
  return (
    <div style={s.diagramBox}>
      {children}
      <p style={{ margin: "10px 0 0", fontSize: "13px", color: "#3f5f5c", fontWeight: 700 }}>{caption}</p>
    </div>
  );
}
...
const PARTS = [
  { href: "/cpt/e-m/99000-series-guidelines-reviewer", label: "Part 1 (Rules common to all E/M)" },
  { href: "/cpt/e-m/99000-series-guidelines-reviewer-part-2", label: "Part 2 (Picking the level)" },
  { href: "/cpt/e-m/99000-series-guidelines-reviewer-part-3", label: "Part 3 (Critical care & prolonged)" },
];
...
export function ReviewerShell({ part, subtitle, intro, sections }: { part: 1 | 2 | 3; subtitle: string; intro: ReactNode; sections: Subsection[] }) {
  return (
    <main style={s.main}>
      <header style={s.hero}>
        <p style={s.kicker}>99,000 SERIES · EVALUATION & MANAGEMENT</p>
        <h1 style={{ margin: 0, fontSize: "clamp(28px, 5.5vw, 48px)" }}>E/M Guidelines Reviewer</h1>
      ...
      <nav aria-label="E/M series navigation" style={s.nav}>
        <Link href="/cpt/e-m/99,000" style={s.navLink}>99,000 Series home</Link>
        <Link href="/cpt/e-m/99000-series-discussion-guide" style={s.navLink}>Discussion Guide</Link>
        <Link href="/cpt/e-m" style={s.navLink}>E/M Series home</Link>
      ...
      <div style={{ marginTop: "30px", display: "flex", flexWrap: "wrap", gap: "16px" }}>
        {part > 1 && <Link href={PARTS[part - 2].href} style={{ textDecoration: "none", color: "#0f766e", fontWeight: 700 }}>← Previous part</Link>}
        {part < 3 && <Link href={PARTS[part].href} style={{ textDecoration: "none", color: "#0f766e", fontWeight: 700 }}>Continue to next part →</Link>}
        <Link href="/cpt/e-m/99,000" style={{ textDecoration: "none", color: "#0f766e", fontWeight: 700 }}>← Back to the 99,000 Series</Link>
      </div>
    </main>
  );
}
