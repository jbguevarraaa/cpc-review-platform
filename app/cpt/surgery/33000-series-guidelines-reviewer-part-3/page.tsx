  ...
  return (
    <main style={mainStyle}>
      <header style={heroStyle}>
        ...
        <p style={{ margin: "12px 0 0", fontSize: "19px", lineHeight: 1.5 }}>Part 3 — Venous Access, Arterial Access, Dialysis Circuit, Portal Decompression &amp; Thrombectomy (36555–37214)</p>
      </header>
      ...
      <div style={pagerStyle}>
        ...
        <span style={pagerActiveStyle}>Part 3 (36555–37214)</span>
      </div>
      ...
      <section style={introBoxStyle}>
        <strong>One small gap remaining:</strong> everything through venous mechanical thrombectomy (37187/37188) and thrombolytic infusion (37211–37214) is now complete. If a later CPT section (general vascular repair, embolectomy, etc., 37220 onward) is needed, send it and it can be added as a Part 4.
      </section>
