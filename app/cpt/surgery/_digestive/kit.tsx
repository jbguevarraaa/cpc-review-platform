...
const s = {
  main: { maxWidth: "1160px", margin: "0 auto", padding: "36px clamp(12px, 4vw, 24px) 64px", minHeight: "100vh", background: "#fff8f3", color: "#2b1a12", fontFamily: "Arial, sans-serif" },
  hero: { background: "linear-gradient(135deg, #431407, #c2410c)", color: "white", padding: "48px clamp(20px, 4vw, 44px)", borderRadius: "18px", marginBottom: "26px", boxShadow: "0 12px 28px rgba(67,20,7,0.22)" },
  kicker: { margin: "0 0 10px", color: "#fed7aa", fontWeight: 800, letterSpacing: "0.08em" },
  nav: { display: "flex", flexWrap: "wrap" as const, gap: "10px", marginBottom: "22px" },
  navLink: { textDecoration: "none", color: "#c2410c", background: "#ffffff", border: "1px solid #f1e0d3", borderRadius: "999px", padding: "10px 15px", fontWeight: 700, fontSize: "14px" },
  pagerLink: { textDecoration: "none", color: "#c2410c", background: "#fff1e6", border: "1px solid #fed7aa", borderRadius: "999px", padding: "8px 16px", fontWeight: 700, fontSize: "14px" },
  pagerActive: { textDecoration: "none", color: "#fff", background: "#c2410c", border: "1px solid #c2410c", borderRadius: "999px", padding: "8px 16px", fontWeight: 700, fontSize: "14px" },
  intro: { background: "#fff1e6", border: "1px solid #fed7aa", borderLeft: "7px solid #c2410c", borderRadius: "12px", padding: "22px 24px", marginBottom: "26px", lineHeight: 1.7 },
  section: { background: "#ffffff", border: "1px solid #f1e0d3", borderRadius: "14px", padding: "24px clamp(14px, 3.5vw, 28px)", marginBottom: "22px", boxShadow: "0 5px 16px rgba(67,20,7,0.06)" },
  sectionHeader: { display: "flex", alignItems: "center", gap: "14px", marginBottom: "10px", flexWrap: "wrap" as const },
  num: { background: "#c2410c", color: "#fff", width: "36px", height: "36px", minWidth: "36px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: "15px" },
  title: { margin: 0, fontSize: "22px", color: "#111827" },
  range: { background: "#fff1e6", border: "1px solid #fed7aa", color: "#c2410c", borderRadius: "999px", padding: "4px 12px", fontWeight: 800, fontSize: "13px", fontFamily: "Consolas, monospace" },
  p: { lineHeight: 1.75, margin: "0 0 10px" },
  catTitle: { margin: "18px 0 8px", fontSize: "16px", color: "#c2410c", fontWeight: 800 },
  codeList: { listStyle: "none", padding: 0, margin: "0 0 4px", display: "grid", gap: "7px" },
  codeItem: { display: "flex", flexWrap: "wrap" as const, gap: "6px 12px", alignItems: "baseline", background: "#fffaf6", border: "1px solid #f1e0d3", borderRadius: "8px", padding: "8px 13px" },
  codeChip: { fontWeight: 800, color: "#c2410c", minWidth: "120px", fontFamily: "Consolas, monospace", fontSize: "13.5px" },
  ul: { margin: 0, paddingLeft: "20px", display: "grid", gap: "8px" },
  diagramBox: { background: "#fffaf6", border: "1px solid #f1e0d3", borderRadius: "14px", padding: "18px", margin: "16px 0", textAlign: "center" as const, overflowX: "auto" as const },
};
...
export function DiagramFrame({ caption, children }: { caption: string; children: ReactNode }) {
  return (
    <div style={s.diagramBox}>
      {children}
      <p style={{ margin: "10px 0 0", fontSize: "13px", color: "#7c3a1a", fontWeight: 700 }}>{caption}</p>
    </div>
  );
}
...
const PARTS = [
  { href: "/cpt/surgery/40000-series-guidelines-reviewer", label: "Part 1 (Upper GI endoscopy & ERCP)" },
  { href: "/cpt/surgery/40000-series-guidelines-reviewer-part-2", label: "Part 2 (Lower GI endoscopy)" },
  { href: "/cpt/surgery/40000-series-guidelines-reviewer-part-3", label: "Part 3 (Bariatric, hernia, anus)" },
];
  ...
  return (
    <main style={s.main}>
      ...
      <div style={{ marginTop: "30px", display: "flex", flexWrap: "wrap", gap: "16px" }}>
        {part > 1 && <Link href={PARTS[part - 2].href} style={{ textDecoration: "none", color: "#c2410c", fontWeight: 700 }}>← Previous part</Link>}
        {part < 3 && <Link href={PARTS[part].href} style={{ textDecoration: "none", color: "#c2410c", fontWeight: 700 }}>Continue to next part →</Link>}
