  ...
  return (
    <main style={{ padding: "40px" }}>
      ...
      <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
        ...
        <Link href="/cpt/surgery/20000-series-discussion-guide" style={{ textDecoration: "none", color: "inherit" }}>
          <div style={{ border: "1px solid #ddd", borderRadius: "12px", padding: "25px", width: "320px", backgroundColor: "white", cursor: "pointer", boxShadow: "0 3px 10px rgba(0,0,0,0.05)" }}>
            <h3 style={{ fontSize: "20px", marginBottom: "10px" }}>🗂️ Discussion Guide</h3>
