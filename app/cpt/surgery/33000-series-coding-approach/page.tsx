...
const checklist: ChecklistItem[] = [
  {
    ...
    why: "This is the first and most important question — it sends you to one of eight \"neighborhoods\" in the 33,000 series before you even think about a specific code number. Cardiovascular coding fails most often when someone starts hunting for a code before pinning down which system is involved.",
...
const families: FamilyCard[] = [
  ...
  },
  {
    ...
    distinction: "TAVR/TAVI already bundles nearly everything (access, valvuloplasty, delivery, positioning, temporary pacing, closure, and imaging) — diagnostic catheterization is only separately billable under narrow exceptions (no prior study available, anatomy inadequately visualized, or a clinical change requiring new evaluation).",
  ...
  },
  {
    ...
    lookFor: [
      ...
      "For ECMO/ECLS: initiation, daily management, cannula insertion, or cannula repositioning — these are four distinct services, never billed as if they were the same thing.",
  ...
  },
  {
    ...
    distinction: "The dialysis-circuit intervention codes are organized as their own ladder of increasing complexity (angioplasty → stent → thrombectomy within the circuit) — identify the highest level of work actually performed rather than stacking every step individually.",
