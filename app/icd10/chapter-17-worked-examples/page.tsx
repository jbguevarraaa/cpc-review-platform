...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      "B. The pneumonia code first, then Q90.9 as a secondary diagnosis",
  ...
  },
  {
    ...
    scenario: "A provider documents a rare congenital malformation syndrome that has no specific code and lands in Q87.89. The child also has documented seizures and hearing loss.",
    options: [
      "A. Q87.89 only — the manifestations are inherent",
      "B. Codes for the seizures and hearing loss only",
      "C. Q87.89 plus separate codes for the seizures and the hearing loss",
  ...
  },
  {
    ...
    options: [
      "A. Q89.7 only",
      "B. Q89.7 plus a code for the hearing loss",
      "C. Codes for the malformations the coder thinks are likely",
  ...
  },
  {
    ...
    options: [
      ...
      "B. G82.2- as an additional code",
      "C. Q07.0- as an additional code",
      "D. Replace Q05.2 with a paraplegia code",
    ],
    correct: "B",
  ...
  },
  {
    ...
    options: [
      ...
      "B. Ventricular septal defect code only",
      "C. Both codes",
  ...
  },
  {
    ...
    options: [
      ...
      "B. Z87.74, personal history of (corrected) congenital malformations of the heart and circulatory system",
  ...
  },
  {
    ...
    options: [
      ...
      "B. The Chapter 17 Q code",
      "C. No code — Q codes expire in childhood",
  ...
  },
  {
    ...
    options: [
      ...
      "B. Z38.00, then the cleft lip code from Q36",
      "C. Z38.01, then the cleft lip code",
      "D. Z38.00 only",
    ],
    correct: "B",
