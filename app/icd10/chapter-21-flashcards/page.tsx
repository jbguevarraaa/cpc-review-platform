...
const cards: Card[] = [
  ...
  { topic: "Observation", front: "Observation codes (Z03, Z04, Z05) — when?", back: "For suspected conditions that are RULED OUT, with no related signs or symptoms. Primarily first-listed; secondary if unrelated to the principal diagnosis." },
